    ...
    <section class="practice">
        <div class="container">
            <div class="practice__inner">
                <div class="practice__content">
                    ...
                    <h1 class="practice__title second wow animate__animated animate__fadeInUp" data-wow-delay="1.4s">
                        Требуется помощь в решении корпоративных споров?
                    </h1>
                </div>
            ...
            <p class="text practice__text wow animate__animated animate__fadeInUp" data-wow-delay="1.6s">
                Споры, которые возникают внутри компании – это всегда угроза стабильному развитию и процветанию бизнесу.
                Возникновение конфликтных ситуаций в управленческой деятельности, раздел акций, распределение долей и
                прочие вопросы корпоративного права требуют внимания профессионалов. Привлечение адвокатов по
                корпоративным спорам поможет сохранить бизнес и решить возникшие проблемы наиболее выигрышным способом.
            </p>
            <p class="text practice__text wow animate__animated animate__fadeInUp" data-wow-delay="1.8s">
                Благодаря многолетнему опыту наших адвокатов, любые корпоративные споры и конфликтные ситуации будут
                решены с максимальной выгодой и минимальными потерями.
            </p>
            <h1 class="practice__title-categories wow animate__animated animate__fadeInUp" data-wow-delay="2s">
                Вопросы, с которыми работают наши адвокаты:
            </h1>
            <div class="practice__categories">
                ...
                <div class="practice__categorie wow animate__animated animate__fadeInRight" data-wow-delay="0.3s">
                    вопросы наследования или разделения акций и долей ООО
                </div>
                <div class="practice__categorie wow animate__animated animate__fadeInRight" data-wow-delay="0.3s">
                ...
                <div class="practice__categorie wow animate__animated animate__fadeInRight" data-wow-delay="0.3s">
                    избрание, прекращение и приостановление полномочий управленческого состава
                </div>
            </div>
        </div>
    </section>
    <section class="practice__stages">
        <div class="container">
            <h1 class="practice__stages-title title wow animate__animated animate__fadeInUp" data-wow-delay="1s">
                Этапы работы адвоката по корпоративному праву
            </h1>
            <div class="practice__stages-inner">
                <div class="practice__stages-item wow animate__animated animate__fadeInUp">
                    ...
                    <div class="practice__stages-text text">
                        На консультации, которую можно провести в любом удобном формате, адвокаты разберут материалы
                        дела и проведут анализ всех обстоятельств. Информацию по делу лучше предоставить заранее.
                    </div>
                </div>
                <div class="practice__stages-item wow animate__animated animate__fadeInUp">
                    <div class="practice__stages-head">
                    ...
                    <div class="practice__stages-text text">
                        После анализа документов и сути спора адвокаты формируют правовую позицию, в соответствии с
                        которой адвокаты будут отстаивать ваши интересы в дальнейшем.
                    </div>
                </div>
                <div class="practice__stages-item wow animate__animated animate__fadeInUp">
                    <div class="practice__stages-head">
                    ...
                    <div class="practice__stages-text text">
                        Если корпоративный спор можно урегулировать в досудебном порядке, то наши адвокаты непременно
                        добьются такого решения. Это сэкономит ваши силы и время и поможет быстрее вернуться в
                        стабильный ритм.
                    </div>
                </div>
            </div>
