...
<body>
    ...
    <section class="services services-page" style="background-image: url(images/service-bg.png);">
        <div class="container">
            <div class="services__suptitle suptitle  wow animate__animated animate__fadeInUp animate__delay-1s">
                ПОМОЩЬ В ЛЮБОМ ВОПРОСЕ
            </div>
            <h1 class="title services__title  wow animate__animated animate__fadeInUp animate__delay-1s">
                Ключевые практики
            </h1>
            <div class="services__inner">
                <a href="semeynoye-pravo.html" class="services__link wow animate__animated animate__fadeInUp" data-wow-delay="1s">
                    Семейное право
                </a>
                <a href="grazhdanskoye-pravo.html" class="services__link wow animate__animated animate__fadeInUp " data-wow-delay="1.2s">
                    Гражданское право
                </a>
                <a href="korporativnoye-pravo.html" class="services__link wow animate__animated animate__fadeInUp" data-wow-delay="1.3s">
                    Корпоративное право
                </a>
                <a href="nasledstvennoye-pravo.html" class="services__link wow animate__animated animate__fadeInUp" data-wow-delay="1.4s">
                    Наследственное право
                </a>
                <a href="practice-law.html" class="services__link wow animate__animated animate__fadeInUp" data-wow-delay="1.5s">
                    Уголовное право
                </a>
                <a href="administrativnoye-pravo.html" class="services__link wow animate__animated animate__fadeInUp" data-wow-delay="1.6s">
                    Административное право
                </a>
                <a href="arbitrazhnoye-pravo.html" class="services__link wow animate__animated animate__fadeInUp" data-wow-delay="1.7s">
                    Арбитражное право
                </a>
                <a href="predstavitelstvo-v-sude.html" class="services__link wow animate__animated animate__fadeInUp" data-wow-delay="1.8s">
                    Представительство в суде
                </a>
                <a href="pravovoy-analiz-dokumentov.html" class="services__link wow animate__animated animate__fadeInUp" data-wow-delay="1.9s">
                ...
                <a href="brachnyy-kontrakt.html" class="services__link wow animate__animated animate__fadeInUp" data-wow-delay="2.1s">
                    Составление брачных контрактов
                </a>
                <a href="sostavlenie-dogovorov.html" class="services__link wow animate__animated animate__fadeInUp" data-wow-delay="2.2s">
                    Составление договоров
                </a>
                <a href="pravovoy-audit.html" class="services__link wow animate__animated animate__fadeInUp" data-wow-delay="2.3s">
                    Правовой аудит
                </a>
                <a href="soprovozhdeniye-sdelok-s-nedvizhimostyu.html" class="services__link wow animate__animated animate__fadeInUp" data-wow-delay="2.4s">
                    Сопровождение сделок с недвижимостью
                </a>
                <a href="zashchita-prav-potrebiteley.html" class="services__link wow animate__animated animate__fadeInUp" data-wow-delay="2.5s">
                    Защита прав потребителей
                </a>
                <a href="drugiye-yuridicheskiye-voprosy.html" class="services__link wow animate__animated animate__fadeInUp" data-wow-delay="2.6s">
                    Другие юридические аспекты
                </a>
            </div>
            <div class="services__items">
                <div class="services__item wow animate__animated animate__fadeInUp" data-wow-delay="3s">
                    <div class="services__icon">
                        <img src="images/icons/services-icon.svg" alt="">
                    </div>
                    <h3 class="services__item-title">
                        Оказываем более
                        5000 юридических услуг
                    </h3>
                </div>
                <div class="services__item wow animate__animated animate__fadeInUp" data-wow-delay="3.3s">
                    <div class="services__icon">
                        <img src="images/icons/services-icon.svg" alt="">
                    </div>
                    <h3 class="services__item-title">
                ...
                <div class="services__item wow animate__animated animate__fadeInUp" data-wow-delay="3.7s">
                    <div class="services__icon">
                        <img src="images/icons/services-icon.svg" alt="">
                    </div>
                    <h3 class="services__item-title">
