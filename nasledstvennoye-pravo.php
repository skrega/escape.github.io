...
<body>
    ...
    <section class="practice">
        <div class="container">
            <div class="practice__inner">
                <div class="practice__content">
                    ...
                    <h1 class="practice__title second wow animate__animated animate__fadeInUp" data-wow-delay="1.4s">
                        Хотите отстоять свои права и решить споры о наследстве?
                    </h1>
                </div>
            ...
            <p class="text practice__text wow animate__animated animate__fadeInUp" data-wow-delay="1.6s">
                Наследственные споры часто возникают между родственниками и зачастую решить возникшие трудности может
                только профессионал. У подобных конфликтов есть своя специфика. Ситуация осложняется тем, что каждый из
                участников может иметь свои права на долю в наследстве, а урегулированию конфликта часто мешают личные
                взаимоотношения. Нередки ситуации, когда, не желая уступать, некоторые участники процесса прибегают к
                мошенничеству и обману.
            </p>
            <p class="text practice__text wow animate__animated animate__fadeInUp" data-wow-delay="1.8s">
                Адвокат окажет поддержку в решении любых вопросов, связанных с процессом наследования. Опыт в успешном
                разрешении конфликтов и достижении досудебных соглашений позволит адвокату добиться наилучшего варианта.
            </p>
            <h1 class="practice__title-categories wow animate__animated animate__fadeInUp">
                Адвокат защитит вас в следующих спорах, связанных с вопросами наследования:
            </h1>
            <div class=" practice__categories">
                ...
                <div class="practice__categorie wow animate__animated animate__fadeInRight" data-wow-delay="0.3s">
                    определение лиц, претендующих на долю в наследовании
                </div>
                <div class="practice__categorie wow animate__animated animate__fadeInRight" data-wow-delay="0.3s">
    ...
    <section class="practice__stages">
        <div class="container">
            <h1 class="practice__stages-title title wow animate__animated animate__fadeInUp" data-wow-delay="0.5s">
                Этапы работы адвоката по вопросам наследования
            </h1>
            <div class="practice__stages-inner">
                <div class="practice__stages-item wow animate__animated animate__fadeInUp">
                    ...
                    <div class="practice__stages-text text">
                        На консультации адвокат проанализирует текущее дело и определит направление для дальнейшей
                        работы. Консультацию можно провести в любом удобном формате.
                    </div>
                </div>
                <div class="practice__stages-item wow animate__animated animate__fadeInUp">
                    <div class="practice__stages-head">
                    ...
                    <div class="practice__stages-text text">
                        После изучения документов и всех материалов дела, адвокат сформулирует правовую позицию по делу
                        и подготовит документы для дальнейшего решения поставленной задачи.
                    </div>
                </div>
                <div class="practice__stages-item wow animate__animated animate__fadeInUp">
                    <div class="practice__stages-head">
                    ...
                    <div class="practice__stages-text text">
                        В большинстве случаев разрешить проблемы между родственниками можно не прибегая к судебному
                        процессу. У наших адвокатов есть большой опыт в досудебном урегулировании конфликтов с
                        благоприятным решением для сторон.
                    </div>
                </div>
                <div class="practice__stages-item wow animate__animated animate__fadeInUp">
                    <div class="practice__stages-head">
                    ...
                    <div class="practice__stages-text text">
                        В случаях, когда решить вопрос в досудебном порядке не удалось или имело место мошенничество,
                        адвокат будет представлять ваши интересы в суде, чтобы добиться выгодного для вас решения.
                    </div>
                </div>
            </div>
        </div>
