        ...
        <div class="container">
            <div class="practice__inner">
                <div class="practice__content">
                    <div class="practice__suptitle suptitle">
                        КЛЮЧЕВЫЕ ПРАКТИКИ
                    </div>
                    <h1 class="practice__title title">
                        <span></span>
                    </h1>
                    <h1 class="practice__title second">
            ...
            <p class="text practice__text">

            </p>
            <p class="text practice__text">

            </p>
            <h1 class="practice__title-categories">

            </h1>
            <div class="practice__categories">
                <div class="practice__categorie">
    ...
    <section class="practice__stages">
        <div class="container">
            ...
            <div class="practice__stages-inner">
                <div class="practice__stages-item">
