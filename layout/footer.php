                ...
                <div class="footer__column-inner">
                    <div class="footer__links">
                        <div class="footer__links-col">
                            ...
                            <a href="fonder.php" class="footer__link">Основатель</a>
                        </div>
                        <div class="footer__links-col">
                            <a href="services.php" class="footer__link">Услуги</a>
                            <a href="case.php" class="footer__link">Кейсы</a>
                        </div>
                        <div class="footer__links-col">
                            <a href="rewievs.php" class="footer__link">Отзывы</a>
                            <a href="contacts.php" class="footer__link">Контакты</a>
                        </div>
                    </div>
                    <div class="footer__social">
                        <a href="tel:+79046291818" class="footer__social-link phone">
                ...
                <div class="footer__media">
                    <a href="https://www.instagram.com/auvasiliev/" class="footer__media-link">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M12.046 4.55835C12.5854 4.55835 13.0227 4.12108 13.0227 3.58167C13.0227 3.04226 12.5854 2.60498 12.046 2.60498C11.5066 2.60498 11.0693 3.04226 11.0693 3.58167C11.0693 4.12108 11.5066 4.55835 12.046 4.55835Z" fill="#0764E3" />
                        </svg>
                    </a>
                    <a href="https://www.facebook.com/%D0%90%D0%BD%D0%B4%D1%80%D0%B5%D0%B9-%D0%92%D0%B0%D1%81%D0%B8%D0%BB%D1%8C%D0%B5%D0%B2-%D0%90%D0%B4%D0%B2%D0%BE%D0%BA%D0%B0%D1%82-2221603111217790/?ref=page_internal" class="footer__media-link">
                        <svg width="8" height="16" viewBox="0 0 8 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M6.53945 2.49062H8V0.105625C7.74802 0.073125 6.88143 0 5.87218 0C3.76635 0 2.32381 1.24187 2.32381 3.52437V5.625H0V8.29125H2.32381V15.5H5.1729V8.29187H7.40272L7.75669 5.62563H5.17224V3.78875C5.1729 3.01813 5.39422 2.49062 6.53945 2.49062Z" fill="#0764E3" />
                        </svg>
                    </a>
                </div>
            </div>
